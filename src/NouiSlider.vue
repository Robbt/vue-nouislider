        ...
        if (!this.isInnerChange) {
          ...
          if (this.sliderStartValue) {
            if (handle === 0) {
              ...
              this.$emit('update:sliderStartValue', this.sliderStartValue)
            } else {
              this.sliderEndValue = values[handle]
              this.$emit('update:sliderEndValue', this.sliderEndValue)
            }
          } else {
            this.sliderEndValue = values[handle]
            this.$emit('update:sliderEndValue', this.sliderEndValue)
